...
import { PushNotifyDialog } from '@/components/group/push-notify-dialog'
...
export default function GroupDetailPage() {
  ...
  const { tags, fetchTags } = useGroupTags()
  ...
  const [pushNotifyMachine, setPushNotifyMachine] = useState<string | null>(null)
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 overflow-y-auto px-4 py-3">
        {gd.stores.length === 0 && !gd.isLoading ? (
          ...
          <GroupMachineList
            ...
            onPushNotify={machineNumber => setPushNotifyMachine(machineNumber)}
          />
        )}
      </div>
      ...
      {pushNotifyMachine && (
        <PushNotifyDialog
          open={!!pushNotifyMachine}
          onOpenChange={open => { if (!open) setPushNotifyMachine(null) }}
          machineNumber={pushNotifyMachine}
